...
- [x] All questions in `src/short-response.md` are answered
- [x] All functions in `src/from-scratch.js` are written
- [ ] All links are provided in `src/system-design.md` are fixed
- [x] Short responses have been proofread and cleared of any typos or grammar mistakes.
